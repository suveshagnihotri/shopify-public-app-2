...
app.get('/', async (req, res) => {
  ...
  try {
    ...
    // Return beautiful HTML page instead of JSON
    ...
    res.status(200).send(`
      ...
      <html lang="en">
        <head>
          ...
          <title>Peeq - ${shop.name || 'Shopify App'}</title>
          <style>
            * {
              margin: 0;
              padding: 0;
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p>Your Shopify store is now connected to Peeq</p>
            </div>
            ...
            <div class="content">
              <div class="shop-info">
                ...
                <div class="info-grid">
                  ...
                  <div class="info-item">
                    ...
                    <span class="info-value">${shop.domain || shop.myshopify_domain || session.shop}</span>
                  </div>
                  <div class="info-item">
                    <span class="info-label">Email</span>
                    <span class="info-value">${shop.email || shop.customer_email || 'N/A'}</span>
                  </div>
                  <div class="info-item">
                    <span class="info-label">Country</span>
                    <span class="info-value">${shop.country_name || shop.country_code || 'N/A'}</span>
                  </div>
                  <div class="info-item">
                    <span class="info-label">Currency</span>
                    <span class="info-value">${shop.currency || 'N/A'}</span>
                  </div>
                  <div class="info-item">
                    <span class="info-label">Plan</span>
                    <span class="info-value">${shop.plan_display_name || shop.plan_name || 'N/A'}</span>
                  </div>
                  <div class="info-item">
                  ...
                  <div class="info-item">
                    ...
                    <span class="info-value">${shop.shop_owner || 'N/A'}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="stats">
                <div class="stat-card">
                  <div class="stat-value">${shop.has_discounts ? '✓' : '—'}</div>
                  <div class="stat-label">Discounts</div>
                </div>
                <div class="stat-card">
                  <div class="stat-value">${shop.has_gift_cards ? '✓' : '—'}</div>
                  <div class="stat-label">Gift Cards</div>
                </div>
                <div class="stat-card">
                  <div class="stat-value">${shop.has_storefront ? '✓' : '—'}</div>
                  <div class="stat-label">Storefront</div>
                </div>
                <div class="stat-card">
                  <div class="stat-value">${shop.eligible_for_payments ? '✓' : '—'}</div>
                  <div class="stat-label">Payments</div>
                </div>
              </div>
              
              <div class="actions">
                <a href="/api/products?shop=${encodeURIComponent(session.shop)}" class="btn btn-primary">
                  <span>📦</span>
                  View Products
                </a>
                <a href="https://admin.shopify.com/store/${session.shop.replace('.myshopify.com', '')}" class="btn btn-secondary" target="_blank">
                  <span>⚙️</span>
                  Shopify Admin
                </a>
              </div>
